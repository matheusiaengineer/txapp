...
const savedPlaces: SavedPlace[] = [
  ...
  { id: "2", name: "Trabalho", address: "Av. Brigadeiro Faria Lima, 2000 - Pinheiros", icon: Briefcase, color: "#8B5CF6", isFavorite: true },
  { id: "3", name: "Academia", address: "Rua Augusta, 500 - Consolação", icon: MapPin, color: "#F59E0B", isFavorite: false },
  { id: "4", name: "Casa da Mãe", address: "Av. São João, 1500 - Centro", icon: Heart, color: "#EC4899", isFavorite: true },
];
          ...
          <div className="space-y-3">
            ...
            {places.length === 0 && (
              ...
              >
                ...
                <p className="text-sm text-gray-500">Nenhum lugar salvo ainda</p>
                <p className="text-xs text-gray-600 mt-1">
                  Adicione seus endereços frequentes
                </p>
              </motion.div>
            )}
          </div>
            ...
            <div className="glass-panel p-5">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>Salve endereços frequentes para corridas mais rápidas</span>
                </li>
                <li className="flex items-start gap-2">
                  <Star className="w-4 h-4 text-yellow-400 mt-0.5 shrink-0" />
                  <span>Favoritos aparecem primeiro nas sugestões</span>
                </li>
              </ul>
            </div>
          </div>
